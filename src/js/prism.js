/* PrismJS 1.11.0
http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+c+bash+cpp+java+latex+python&plugins=line-highlight+line-numbers+file-highlight+toolbar+command-line+show-language */
